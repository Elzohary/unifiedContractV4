...
namespace UnifiedContract.Persistence.Migrations
{
    ...
    [Migration("20250720144259_AddPaymentTypeManagementAreaCurrencyToWorkOrderItem")]
    partial class AddPaymentTypeManagementAreaCurrencyToWorkOrderItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UnifiedContract.Domain.Entities.Auth.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IsEmployee = false,
                            LastModifiedBy = "seed",
                            PasswordHash = "849f1575ccfbf3a4d6cf00e6c5641b7fd4da2ed3e212c2d79ba9161a5a432ff0",
                            UserName = "testuser"
                        });
                });
